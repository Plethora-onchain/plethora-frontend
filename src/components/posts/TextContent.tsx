  ...
  return (
    <div className="mx-auto max-w-6xl  mb-20">
      <div className="">
        ...
        <div className="px-4 lg:px-0 mt-12 text-gray-700 max-w-screen-md mx-auto text-lg leading-relaxed prose lg:prose-xl">
          ...
          <div className="mb-10">
            ...
            <p className="text-gray-600">
              ...
              volutpat justo sit amet augue facilisis, eu ullamcorper massa
              luctus. Phasellus et velit nec metus sollicitudin facilisis. Nam
              non libero eu nisi fermentum dictum. Cras fermentum, tortor a
              euismod condimentum, urna velit gravida nisi, eu vulputate purus
              dolor sed risus. Sed at tincidunt urna, eget dignissim metus. Sed
              tincidunt, orci ut faucibus accumsan, nunc metus tempus risus, id
              vestibulum tortor ligula id eros.
            </p>
          </div>
